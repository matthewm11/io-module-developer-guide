...
Set user property ``type`` to value ``ipPort``.

To open a TCP or UDP socket on a controller and listen for packets, you must have at least one of these properties in the configuration.
